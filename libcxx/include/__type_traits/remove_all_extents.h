...
#else
_LIBCPP_EXPORT_STD template <class _Tp> struct _LIBCPP_TEMPLATE_VIS remove_all_extents
    {typedef _Tp type;};
...
_LIBCPP_EXPORT_STD template <class _Tp> using remove_all_extents_t = __remove_all_extents_t<_Tp>;
#endif
