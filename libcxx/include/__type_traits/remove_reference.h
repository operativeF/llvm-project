...
#else
_LIBCPP_EXPORT_STD template <class _Tp> struct _LIBCPP_TEMPLATE_VIS remove_reference        {typedef _LIBCPP_NODEBUG _Tp type;};
...
_LIBCPP_EXPORT_STD template <class _Tp> using remove_reference_t = __libcpp_remove_reference_t<_Tp>;
#endif
